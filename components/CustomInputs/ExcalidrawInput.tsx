...
import { distance2d, resolvablePromise, withBatchedUpdates, withBatchedUpdatesThrottled } from "utils/excalidraw"
import initialData from "utils/excalidraw/initialData"
...
export function ExcalidrawInput({ value, onChange }) {
  ...
  return (
    <Dialog>
      ...
      <DialogContent className='flex h-[90vh] w-screen max-w-7xl items-center justify-center'>
        <div className='App flex h-full w-full flex-col' ref={appRef}>
          <h1>Coursition - Excalidraw</h1>
          {/* <ExampleSidebar>  */} {/** TODO: Create a custom Sidebar **/}
          ...
          {/* TODO: Move Export options to seperate modal */}
